      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px' }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '14px', opacity: '0.8', marginBottom: '5px' }}>Altezza</div>
            <div style={{ fontSize: '18px', fontWeight: '600' }}>{faro.altezza}m</div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '14px', opacity: '0.8', marginBottom: '5px' }}>Raggio</div>
            <div style={{ fontSize: '18px', fontWeight: '600' }}>{faro.raggio} mn</div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '14px', opacity: '0.8', marginBottom: '5px' }}>Costruito</div>
            <div style={{ fontSize: '18px', fontWeight: '600' }}>{faro.costruito}</div>
          </div>
        </div>
      </div>
